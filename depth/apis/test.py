...
def single_gpu_test(model,
    ...
    for batch_indices, data in zip(loader_indices, data_loader):
        ...
        with torch.no_grad():
            ...
            result_depth = model(return_loss=False, rescale=True, **data)
            # print(result_depth[0][0])
            # depth_map = 1 / result_depth[0][0]
            # print(type(depth_map))
            # print(depth_map)
            # depth_map = 1 / depth_map
            # print(depth_map)
            # exit()
            # print(result_depth[0][0].shape)
            # exit()

            pred_disps.append(result_depth[0][0])
    ...
    output_path = os.path.join(out_dir, "disp.npz")
