_base_ = [
    '../_base_/models/depthformer_swin.py', '../_base_/datasets/nyu_APR.py',
...
lr_config = dict(
    ...
    warmup='linear',
    warmup_iters=1600 * 8 * 2,
    warmup_ratio=1.0 / 1000,
    min_lr_ratio=1e-8,
    by_epoch=False) # test add by_epoch false
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
# runtime settings
runner = dict(type='IterBasedRunner', max_iters=1600 * 24 * 2)
