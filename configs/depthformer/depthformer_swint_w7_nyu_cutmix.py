_base_ = [
    '../_base_/models/depthformer_swin.py', '../_base_/datasets/nyu_cutmix.py',
    '../_base_/default_runtime.py'
]


data_root = 'data/mixed_dataset/'

model = dict(
    pretrained='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth', # noqa encoder
    backbone=dict(
        embed_dims=96,
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
...
# runtime settings
runner = dict(type='IterBasedRunner', max_iters=1 * 24 * 4)
